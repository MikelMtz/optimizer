...
-----
    python plot_width_sweep_accuracy.py \\
        --output_base output/width_sweep_kink/output \\
        --save_path   output/width_sweep_kink/plots/width_sweep_accuracy.pdf
"""
...
# ── Constants ─────────────────────────────────────────────────────────────────
ALL_WIDTHS = [0.25, 0.5, 1, 2, 4, 8, 16]
...
def parse_args():
    ...
    p.add_argument("--output_base", default="output/width_sweep_kink/output")
    p.add_argument("--widths", type=int, nargs="+", default=ALL_WIDTHS)
    p.add_argument("--save_path",
                   default="output/width_sweep_kink/plots/width_sweep_accuracy.pdf")
...
def main():
    ...
    fig.suptitle(
        "Kink Dataset — Test Accuracy vs. Network Width\n"
